...
let book = {
  ...
  discription: function () {
    console.log(
      `hey I want the book named ${this.name} by ${book.author} and its popularity is ${this.popularity} in ${book.publish_date}\n Thank you`
    );
  },
};
book.discription();
...
let my_info = {
  ...
  details: function () {
    console.log(
      `hello there I am ${this.name} and ${my_info.age} years old ,which I am studying is ${this.field} at ${this.institude} and yeah that's it.\n\n`
    );
  },
};
my_info.details();
