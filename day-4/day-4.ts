...
let mamma:string='My mother';//Here I am adding comments 
...
//My first try
let array_1:string[]=['tuba','bushra','mamma','nayab','asani','pareshani'];
...
let array_2:string[]=['anmol','nayab','mamma','bushra','tuba','arosa','barera']
...
//array_3[2] = mamma 
//array_3[3] = bushra 
let array_3:string[]=['anmol','nayab','mamma','bushra','tuba','arosa','barera']
