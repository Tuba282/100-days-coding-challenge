console.log(`\t\tIts my day-27 to day-29-`);
...
function change_cases(word: string):any {
...
function colour(...colors:string[]):number{
...
function using_replace(line:string):string{
...
function using_includes(line:string):boolean{
...
function using_substring(line:string):string{
...
//the output would be `Hey People , Hope you all are good`