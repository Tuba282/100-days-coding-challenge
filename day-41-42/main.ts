...
let pet = {
  ...
  nature: function () {
    ...
    const kind = () => {
      console.log(
        `here I am using inner method of function by calling my pet's name is ${this.name}`
      );
    };
...
let certificate = {
  ...
  result: function () {
    ...
    console.log(
      `my name is ${this.name} and I am ${this.age} years old and I got very bad marks in all subjects`
    );
    let inner_function = () => {
      console.log(`And I am Certify ${this.certify}`);
    };
